  ...
  return (
    <form className="Form-container" onSubmit={handleSubmit(onSubmit)}>
      ...
      <div className="Form-inputs">
        <input {...register('email')} id="email" type="email" placeholder="Correo Electrónico" />
        <input {...register('password')} id="password" type="password" placeholder="Contraseña" />
      </div>
      {view === 'register' ?
        <button type='submit' id='Register-button' className="Form-button">Registrar</button>
        :
        <button type='submit' id='Login-button' className="Form-button">Ingresar</button>
      }
